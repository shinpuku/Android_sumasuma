...
public class Help_Fragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
     ...
     WebView myWebView = (WebView)view.findViewById(R.id.wv5);
     ...
     myWebView.loadUrl("http://my-log.jp/sumasuma/help/?customer_id="+First_Activity.preference.getString("id", "0"));
        return view;
    }
	
	public static Help_Fragment createInstance() {
